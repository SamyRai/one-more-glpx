...
export const POSTS: Post[] = [
  {
    ...
    excerpt: "Where TLS actually terminates; Terminate vs Passthrough; common misconfigs.",
    date: "2025-10-02",
    topic: "Networking",
  ...
  },
  {
    ...
    excerpt: "Stop dueling webhooks. Use ValidatingAdmissionPolicy for guardrails; Kyverno for generation/mutation.",
    date: "2025-10-03",
    topic: "Policy",
  ...
  },
  {
    ...
    excerpt: "A pragmatic path to eBPF data plane with preflight checks and rollback.",
    date: "2025-10-03",
    topic: "Networking",
